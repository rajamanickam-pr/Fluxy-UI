    ...
    public class HomeController : BaseController
    {
        ...
        public async Task<ActionResult> Index(string message)
        {
            ...
            if (isAdultContent)
            {
                ...
                popularVideos = _videoAttributesService.GetList(i => i.IsPublicVideo).OrderByDescending(i => Guid.NewGuid()).Take(9);
                generalVideos = _videoAttributesService.GetList(i => i.Category.Name.Contains("People & Blogs") && i.IsPublicVideo).OrderByDescending(i => Guid.NewGuid()).Take(9);
                infoVideos = _videoAttributesService.GetList(i => i.Category.Name.Contains("Education") && i.IsPublicVideo).OrderByDescending(i => Guid.NewGuid()).Take(9);
                entertainmentVideos = _videoAttributesService.GetList(i => i.Category.Name.Contains("Entertainment") && i.IsPublicVideo).OrderByDescending(i => Guid.NewGuid()).Take(9);
            }
            else
            {
                ...
                popularVideos = _videoAttributesService.GetList(i => i.IsPublicVideo && !i.IsAdultContent).OrderByDescending(i => Guid.NewGuid()).Take(9);
                generalVideos = _videoAttributesService.GetList(i => i.Category.Name.Contains("People & Blogs") && i.IsPublicVideo && !i.IsAdultContent).OrderByDescending(i => Guid.NewGuid()).Take(9);
                infoVideos = _videoAttributesService.GetList(i => i.Category.Name.Contains("Education") && i.IsPublicVideo&& !i.IsAdultContent).OrderByDescending(i => Guid.NewGuid()).Take(9);
                entertainmentVideos = _videoAttributesService.GetList(i => i.Category.Name.Contains("Entertainment") && i.IsPublicVideo&& !i.IsAdultContent).OrderByDescending(i => Guid.NewGuid()).Take(9);
            }
