...
namespace Fluxy.Services.Feed
{
    public sealed class FeedService : IFeedService
    {
        ...
        /// </summary>
        private string FeedId = Guid.NewGuid().ToString();
        ...
        public async Task<SyndicationFeed> GetFeed(CancellationToken cancellationToken)
        {
            SyndicationFeed feed = new SyndicationFeed()
            {
                ...
                Title = SyndicationContent.CreatePlaintextContent("Fluxy Pictures"),
                ...
                Description = SyndicationContent.CreatePlaintextContent(
                    "This is the Fluxy Pictures feed description."),
