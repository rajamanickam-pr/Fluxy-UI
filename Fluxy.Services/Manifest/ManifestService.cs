...
namespace Fluxy.Services.Manifest
{
    public class ManifestService : IManifestService
    {
        ...
        public string GetManifestJson()
        {
            JObject document = new JObject(
                ...
                new JProperty("icons",
                    new JArray(
                        GetIconJObject("~/Images/fp_logo-purple.png", "36x36", "image/png", "0.75"),
                        GetIconJObject("~/Images/fp_logo-purple.png", "48x48", "image/png", "1.0"),
                        GetIconJObject("~/Images/fp_logo-purple.png", "72x72", "image/png", "1.5"),
                        GetIconJObject("~/Images/fp_logo-purple.png", "96x96", "image/png", "2.0"),
                        GetIconJObject("~/Images/fp_logo-purple.png", "144x144", "image/png", "3.0"),
                        GetIconJObject("~/Images/fp_logo-purple.png", "192x192", "image/png", "4.0"))));
