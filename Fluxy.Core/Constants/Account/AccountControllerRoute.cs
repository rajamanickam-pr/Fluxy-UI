...
namespace Fluxy.Core.Constants.Account
{
    public static class AccountControllerRoute
    {
        ...
        public const string PostVerifyCode = ControllerName.Account + "PostVerifyCode";
        ...
        public const string PostForgotPassword = ControllerName.Account + "PostForgotPassword";
        ...
        public const string PostResetPassword = ControllerName.Account + "PostResetPassword";
        ...
        public const string PostSendCode = ControllerName.Account + "PostSendCode";
